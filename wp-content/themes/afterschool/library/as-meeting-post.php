...
function as_set_meeting_post() {
    $labels = array(
        'name'               => _x( '會議', 'post type general name' ),
        'singular_name'      => _x( '會議', 'post type singular name' ),
        'add_new'            => _x( '新增會議', 'meetings' ),
        'add_new_item'       => __( '建立新會議' ),
        'edit_item'          => __( '編輯會議' ),
        'new_item'           => __( '新會議' ),
        'all_items'          => __( '所有會議' ),
        'view_item'          => __( '檢視會議' ),
        'search_items'       => __( '搜尋會議' ),
        'not_found'          => __( '沒有發現任何會議' ),
        'not_found_in_trash' => __( '沒有在垃圾桶中發現任何會議' ), 
        'parent_item_colon'  => '',
        'menu_name'          => '社區會議'
    );
